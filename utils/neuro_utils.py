...
def sleep_phase_distill(teacher_model, student_model, dataloader, device='cuda', 
                       epochs=1, lr=1e-4):
    """
...
def get_lora_modules(model):
    ...
    for name, module in model.named_modules():
        ...
        if (hasattr(module, "get_delta") and 
            hasattr(module, "get_A") and 
            hasattr(module, "get_B")):
            items.append((name, module))
    return items

def create_noise_loader(batch_size=64, n_batches=10, device='cuda', 
